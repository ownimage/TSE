...
public class ControlBase<C extends IControl<C, T, M, R>, T extends IType<M, R>, M extends IMetaType<R>, R, V extends IView>
	...
	public static void validate(final String pDisplayName, final String pPropertyName) {
		...
		if (!Pattern.matches("[a-zA-Z0-9]*", pPropertyName)) { throw new IllegalArgumentException("pPropertyName must only contain characters a-zA-Z0-9, pPropertyName = \"" + pPropertyName + "\"."); }
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ownimage.perception.persist.IPersist#write(com.ownimage.perception.persist.IPersistDB, java.lang.String)
	 */
	@Override
