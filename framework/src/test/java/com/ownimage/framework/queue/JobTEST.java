...
public class JobTEST {
    ...
    public static void setUpBeforeClass() throws Exception {
        final Job job = new Job("name", Priority.NORMAL);
    ...
    public void test01a_ctor() {
        ...
        final String name = "myJob";
        final IJob job = new Job(name, Priority.NORMAL);
    ...
    public void test01b_ctor() {
        ...
        final String name = "test01b_ctor";
        final IJob job = new Job(name, Priority.HIGH);
        assertEquals(name, job.getName());
    ...
    public void test01c_ctor() {
        ...
        final String name = "test01c_ctor";
        final IJob job = new Job(name, Priority.HIGH, name);
        assertEquals(name, job.getName());
        assertEquals(Priority.HIGH, job.getPriority());
    ...
    public void test01d_ctor() {
        ...
        final String name = "test01c_ctor";
        final IJob job = new Job(name, Priority.LOW, name);
        assertEquals(name, job.getName());
    ...
    public void test02a_cancel() {
        ...
        final String name = "test02a_cancel";
        final JobTest job1 = new JobTest(name, Priority.LOW);
        final JobTest job2 = new JobTest(name, Priority.LOW, this);
        final JobTest job3 = new JobTest(name, Priority.LOW, this);
    ...
    public void test02b_cancel() {
        ...
        final String name = "test02b_cancel";
        final IJob job1 = new JobTest(name, Priority.LOW);
    ...
    public void test03a_complete() {
        ...
        final String name = "test03a_complete";
        final JobTest job1 = new JobTest(name, Priority.LOW);
    ...
    public void test04a_error() {
        ...
        final String name = "test04a_error";
        final JobTest job1 = new JobTest(name, Priority.LOW);
    ...
    public void test06a_terminate() {
        ...
        final String name = "test06a_terminate";
        final JobTest job1 = new JobTest(name, Priority.LOW, name);
        final JobTest job2 = new JobTest("x", Priority.LOW, name);
        assertEquals(Status.CREATED, job1.getStatus());
