...
public class ViewFactory implements IViewFactory {
    ...
    public static void setViewFactory(final IViewFactory pViewFactory) {
        if (mViewFactory != null) {
            throw new IllegalStateException("viewFactory delegate has already been set to: " + mViewFactory);
        }
    ...
    public static void stateCheck() {
        if (mViewFactory == null) {
            throw new IllegalStateException("viewFactory delegate has not been set");
        }
    }
