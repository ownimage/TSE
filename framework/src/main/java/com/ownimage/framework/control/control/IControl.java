 ...
 *
 * @param <C> the Control class, e.g. DoubleControl
 * @param <T> the Type class, e.g. DoubleType
 * @param <M> the Meta Type class of the Control e.g. DoubleMetaType
 * @param <R> the Raw Type class of the Control e.g. Double
 */
public interface IControl<C, T, M, R> extends IMouseControl, IPersist, IViewable, Serializable, Cloneable, IProperty<R> {
     ...
     * Clean.
     */
    void clean(); // TODO need to question the visibility of this.
     ...
     * @param pIsMutating the is mutating
     */
     ...
     *
     * @param pValid the new valid
     */
    void setValid(boolean pValid); // TODO need to question the visibility of this
     ...
     *
     * @param pValue      the value
     * @param pSource     the source view
     * @param pIsMutating the is mutating
     * @return true, if successful
     */
    boolean setValue(R pValue, IView pSource, boolean pIsMutating);

    /**
     * Sets the visible flag for this obejct and calls setVisible on all of the Views of this object.
     *
     * @param pVisible the new visible
     * @return this Control
     */
    C setVisible(boolean pVisible);

    void addVisibileListener(IVisibileListener pListener);

    void removeVisibleListener(IVisibileListener pListener);
