...
public class GrafittiHelper {
    ...
    public void clearRectangle(final double pX1, final double pY1, final double pX2, final double pY2) {
        mGrafittiImp.clearRectangle(pX1, pY1, pX2, pY2);
    }
    ...
    public void clearRectangle(final Point pBottomLeft, final Point pTopRight) {
        mGrafittiImp.clearRectangle(pBottomLeft.getX(), pBottomLeft.getY(), pTopRight.getX(), pTopRight.getY());
    }
    ...
    public void clearRectangle(final Rectangle pR) {
        mGrafittiImp.clearRectangle(pR.getX1(), pR.getY1(), pR.getX2(), pR.getY2());
    }
