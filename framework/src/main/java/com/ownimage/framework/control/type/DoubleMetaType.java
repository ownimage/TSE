...
public class DoubleMetaType implements IMetaType<Double> {
     ...
     *
     * @param pMin the min value
     * @param pMax the max value
     */
     ...
     * @param pMin  the min value
     * @param pMax  the max value
     * @param pStep the step size
     * @param pType the display type
     */
     ...
     * (non-Javadoc)
     *
     * @see com.ownimage.framework.control.model.IMetaModel#isValid(java.lang.Object)
     */
    @Override
