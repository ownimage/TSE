...
public class DoubleCurveSegment extends SegmentBase {
	...
	DoubleCurveSegment(final IVertex pStart, final Line pStartTangent, final CurveSegment pStartCurve, final IVertex pEnd, final Line pEndTangent, final CurveSegment pEndCurve,
			final IVertex pThrough) {
		super(pStart, pEnd);
	...
	DoubleCurveSegment(final IVertex pStart, final Line pStartTangent, final Point pControlPoint1, final Point pControlPoint2, final Line pEndTangent, final IVertex pEnd,
			final IVertex pThroughVertex) {
		super(pStart, pEnd);
		mStartTangent = pStartTangent;
		mEndTangent = pEndTangent;
	...
	public double closestLambda(final Point pPoint) {
		...
		if (distance1 < distance2) { return lambda1 / 2.0d; }
