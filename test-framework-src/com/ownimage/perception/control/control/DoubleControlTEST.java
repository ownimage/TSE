...
public class DoubleControlTEST {
	...
	@Test
	public void DoubleControl_Test2b_getValueValue() {
		final DoubleType v = new DoubleType(0.5);
		final DoubleControl d = new DoubleControl("x", "y", mContainer, v);
	...
	// DoubleType v = new DoubleType(5.0);
	// DoubleControl d = new DoubleControl(v);
	//
	// DoubleControl d = new DoubleControl(5.0, m);
	//
	// d.setNormalizedValue(0.0d);
	// assertEquals(0.1d, d.getValueValue(), 0.0d);
	//
	// d.setNormalizedValue(1.0d);
	// assertEquals(0.7d, d.getValueValue(), 0.0d);
	//
	// d.setNormalizedValue(0.5d);
	// assertEquals(0.4d, d.getValueValue(), 0.0d);
	//
	// d.setNormalizedValue(0.1d);
	// assertEquals(0.16d, d.getValueValue(), 0.0d);
	//
	...
	// DoubleControl.DoubleMetaType m = new DoubleControl.DoubleMetaType(0.1d, 0.7d);
	// DoubleControl d = new DoubleControl(5.0, m);
	//
	// d.setValue(0.1d);
	...
	// DoubleControl.DoubleMetaType m = new DoubleControl.DoubleMetaType(0.1d, 0.7d);
	// DoubleControl d = new DoubleControl(0.3, m);
	...
	//
	// assertEquals("Expected restricted to 0.7", 0.7d, d.getValueValue(), 0.0d);
	// d.setValue(5.0);
	// assertEquals("Expected restricted to 0.7", 0.7d, d.getValueValue(), 0.0d);
	//
	// d.setValue(0.2);
	// assertEquals(0.2d, d.getValueValue(), 0.0d);
	//
	// d.setValue(-1.0);
	// assertEquals("Expected restricted to 0.1", 0.1d, d.getValueValue(), 0.0d);
	//
	// d = new DoubleControl(0.2);
	// assertEquals(0.2d, d.getValueValue(), 0.0d);
	//
	// d = new DoubleControl(-0.6d, m);
	// assertEquals("Expected restricted to 0.1", 0.1d, d.getValueValue(), 0.0d);
	//
	// d.setValue(0.5d);
	// DoubleControl d2 = d.duplicate();
	// assertSame("Check expected MetaModel", m, d2.getMetaModel());
	// assertEquals(0.5d, d2.getValueValue(), 0.0d);
	//
	// DoubleControl d3 = d.clone();
	// assertSame("Check expected MetaModel", m, d3.getMetaModel());
	// assertEquals(0.5d, d3.getValueValue(), 0.0d);
	// }
